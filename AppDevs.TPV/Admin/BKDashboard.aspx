<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BKDashboard.aspx.cs" Inherits="AppDevs.TPV.Admin.Dashboard" %>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">App-Devs.TPV</a>
                </div>
                <!-- /.navbar-header -->
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="#"><i class="glyphicon glyphicon-user"></i> Perfil del Usuario</a>
                            </li>
                            <li><a href="#"><i class="glyphicon glyphicon-adjust"></i> Configuración</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="../Sales/Areas.aspx"><i class="fa fa-edit fa-fw"></i>Ventas</a>
                            </li>
                            <li>
